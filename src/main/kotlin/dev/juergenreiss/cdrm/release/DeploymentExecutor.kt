...
// GitLockBusy only ever comes from the GitOps path (GitCommitClient.commitImageChange) —
...
class DeploymentExecutor(
    ...
    fun attemptDeploy(workload: Workload, stage: Stage, image: String): DeployAttemptResult {
        ...
        if (gitOpsTarget != null) {
            ...
            return when (val result = gitCommitClient.commitImageChange(gitOpsTarget, image, commitMessage)) {
